package com.it.yangkun.commonres.status_view;
...
import com.it.yangkun.commonres.R;
...
public class MultipleStatusView extends RelativeLayout {
    ...
    public static final LayoutParams mLayoutParams = new LayoutParams(
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Public_MultipleStatusView, defStyleAttr, 0);
        mEmptyViewResId = a.getResourceId(R.styleable.Public_MultipleStatusView_Public_emptyView, R.layout.custom_empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.Public_MultipleStatusView_Public_errorView, R.layout.custom_error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.Public_MultipleStatusView_Public_loadingView, R.layout.custom_loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.Public_MultipleStatusView_Public_noNetworkView, R.layout.custom_no_network_view);
